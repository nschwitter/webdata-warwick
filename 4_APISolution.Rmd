...
Why does this call work? It works because the page title of the article about Andorra is actually also called "Andorra". 
...
```{r}
searchresults_andorra <- rbind(searchresults, searchresults2)
...
We have collected 40 Wikipedia articles with "Andorra" in the page title in the English Wikipedia. We also know how many word each articles contain. We could repeat this for our list of countries, collecting all articles to then find out how strongly represented different countries are on Wikipedia (and find out whether this depends for example on language spoken, on population size, on GDP, etc.).
...
summary(spacejamcontrib_all$query.pages.265033.contributors.name %in% spacejamcontribnew_all$query.pages.58064305.contributors.name) #81 have edited in both 
